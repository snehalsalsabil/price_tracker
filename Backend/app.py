...
# Define the ProductResult model
...
# Define the TrackedProducts model
...
# Route to submit scraping results
...
# Route to get unique search texts
...
# Route to get product results by search text
@app.route("/results")
...
# Route to get all product results
...
# Route to add a tracked product
...
# Route to toggle tracking status of a product
...
# Route to get all tracked products
...
# Route to update and start scrapers for tracked products
